          ...
          <div class="col-12">
              ...
              >
                <div v-if="!item.datetime && !item.bool && !item.enumeration" class="input-group mb-3">
                  <input v-if="!item.readonly" type="text" v-model="element.text" class="form-control" placeholder="" aria-describedby="basic-addon2">
...
/*  components: {
  ...
  methods: {
    ...
    add: function() {
      this.globalElId++
        //console.log('this.globalElId++',this.globalElId++)
